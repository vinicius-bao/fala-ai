...
chcp 65001 >nul
echo ============================================================
echo   Fala AI - gerar o instalador (Setup.exe)
echo ============================================================
echo.
...
REM --- 2. PyInstaller: gera dist\FalaAI\ ---
echo.
echo [2/3] Gerando o executavel com PyInstaller...
pyinstaller --noconfirm FalaAI.spec || goto :erro

REM --- 3. Inno Setup: gera installer\FalaAI-Setup.exe ---
echo.
...
if errorlevel 1 (
    ...
    echo         O executavel ja esta pronto em: dist\FalaAI\
...
echo.
echo ============================================================
echo   PRONTO! Instalador em: installer\FalaAI-Setup.exe
echo ============================================================
goto :fim
